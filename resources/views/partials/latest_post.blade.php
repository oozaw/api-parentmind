<div class="card mb-5">
   <a href="/post/{{ $posts[0]->slug }}">
      ...
      @else
         <img src="https://source.unsplash.com/random/1200x500?{{ $posts[0]->category->slug }}" class="card-img-top"
            alt="{{ $posts[0]->category->slug }}">
      @endif
   </a>
   <div class="card-body text-center">
      ...
      <p>
         <small class="text-muted">By: <a class="text-decoration-none"
               ...
               class="text-decoration-none">{{ $posts[0]->category->name }}</a><br> Last updated
